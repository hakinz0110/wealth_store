class AppConstants {
  // App Information
  static const String appName = 'Wealth Store Admin';
  static const String appVersion = '1.0.0';
  
  // API Configuration
  static const String supabaseUrl = 'https://zazbfusupfoxdhfgqmno.supabase.co';
  static const String supabaseAnonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InphemJmdXN1cGZveGRoZmdxbW5vIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTE3MzU3NjksImV4cCI6MjA2NzMxMTc2OX0.lQnP3HVDXcINFPavWYzgto84v2vx7jI25nfrlQBJqhA';
